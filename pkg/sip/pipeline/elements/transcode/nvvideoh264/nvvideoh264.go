...
func (e *NvVideoH264) Constructed(instance *glib.Object) {
	...
	// wscaleFilter := glib.WeakRefInit(e.Filter)
	...
	// 		return
	// 	}
	// 	if err := scaleFilter.SetProperty("caps", gst.NewCapsFromString(fmt.Sprintf("video/x-raw(memory:CUDAMemory), width=[1,%d], height=[1,%d], pixel-aspect-ratio=1/1", w, h))); err != nil {
