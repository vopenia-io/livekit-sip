...
type Fallback interface {
	...
	Sync() error
	Remove(e *LivekitCompositor, self *gst.Bin) error
}
...
func (f *AudioFallback) Create(e *LivekitCompositor, self *gst.Bin) (*gst.Pad, error) {
	if f.initialized {
...
func (f *AudioFallback) Remove(e *LivekitCompositor, self *gst.Bin) error {
	if !f.initialized {
...
func (f *VideoFallbackCPU) Create(e *LivekitCompositor, self *gst.Bin) (*gst.Pad, error) {
	if f.initialized {
...
func (f *VideoFallbackCPU) Remove(e *LivekitCompositor, self *gst.Bin) error {
	if !f.initialized {
...
func (f *VideoFallbackNVidia) Create(e *LivekitCompositor, self *gst.Bin) (*gst.Pad, error) {
	if f.initialized {
		return nil, fmt.Errorf("video fallback already initialized")
	}
...
func (f *VideoFallbackNVidia) Remove(e *LivekitCompositor, self *gst.Bin) error {
	if !f.initialized {
		return fmt.Errorf("video fallback not initialized")
	}
...
func (f *VideoFallback) Create(e *LivekitCompositor, self *gst.Bin) (*gst.Pad, error) {
	if f.Fallback != nil {
...
func (f *VideoFallback) Remove(e *LivekitCompositor, self *gst.Bin) error {
	if f.Fallback != nil {
